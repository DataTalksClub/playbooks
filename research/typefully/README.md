...
Raw and timestamped filtered exports are ignored by Git. Promote a reviewed export to `typefully-examples.json`, `typefully-examples.csv`, and `typefully-examples.md` when it should become shared research.
